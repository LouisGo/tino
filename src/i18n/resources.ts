...
export const enUSResources = defineLocaleSchema({
  ...
  dashboard: {
    chat: {
      ...
      emptyConversationHint: "Start a new conversation and keep each topic in its own thread.",
      searchConversations: "Search conversations",
      clearSearch: "Clear search",
      searchFilter: "Filter conversations",
      searchFilters: {
      ...
      searchEmpty: "No conversations matched that search.",
      searchDefaultEmptyTitle: "No conversations yet",
      searchDefaultEmptyDescription:
        "Start a new thread and your conversation history will appear here.",
      searchFilteredEmptyTitle: "No matching conversations",
      searchFilteredEmptyDescription:
      ...
      editingPrompt: "Editing the latest prompt",
      cancelEdit: "Cancel",
      ...
      deleteDescription: "This will permanently remove “{{title}}” and all messages in it.",
      deleteConfirm: "Delete conversation",
      deletePending: "Deleting...",
      pinConversation: "Pin conversation",
      unpinConversation: "Unpin conversation",
      pinnedBadge: "Pinned",
      generatingTitle: "Naming...",
      sidebarMessageCount: "{{count}} messages",
      threadMeta: "{{time}} · {{count}} messages",
...
export const zhCNResources = {
  ...
  dashboard: {
    chat: {
      ...
      newChat: "新建对话",
      newConversation: "新对话",
      conversationHistory: "会话列表",
      draftConversation: "当前草稿",
      emptyConversationHint: "开始一个新的对话，把不同话题放进各自的线程里。",
      ...
      todayConversations: "今天",
      yesterdayConversations: "昨天",
      searchResultsLabel: "搜索结果",
      searchEmpty: "没有匹配这个关键词的会话。",
      searchDefaultEmptyTitle: "还没有会话记录",
      searchDefaultEmptyDescription: "开始一个新的对话，搜索结果会显示在这里。",
      searchFilteredEmptyTitle: "没有匹配的会话",
      searchFilteredEmptyDescription: "可以清空搜索词，重新查看全部会话。",
      modelLabel: "模型",
      providerLabel: "Provider",
      attachmentsLabel: "附件",
      ...
      deleteTitle: "删除这个会话？",
      deleteDescription: "这会永久删除“{{title}}”及其中全部消息。",
      deleteConfirm: "删除会话",
      deletePending: "删除中...",
